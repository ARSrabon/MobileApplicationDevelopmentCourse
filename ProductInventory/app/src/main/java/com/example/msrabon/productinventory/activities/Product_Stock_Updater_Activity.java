...
public class Product_Stock_Updater_Activity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_product_stock_updater);
...
//        Log.d("The loop !!!!","Completed");
        ...
        btn_StockUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                products.setProduct_stock(products.getProduct_stock() + Long.parseLong(edit_ProductStock.getText().toString()));
                ...
                Intent intent1 = new Intent(Product_Stock_Updater_Activity.this,DefaultView_Activity.class);
