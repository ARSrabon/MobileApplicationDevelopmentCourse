...
import com.example.msrabon.activeandroidtest.models.SellHistory;
...
public class Product_Sell_Activity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
            ...
            public void onClick(View view) {
                ...
                if (quantity != 0) {
                    if (quantity <= products.getProduct_stock()) {
                        SellHistory sellHistory = new SellHistory(products.getId(), quantity,products.getProduct_price(),timeStamp);
                    ...
                    Toast.makeText(Product_Sell_Activity.this, "Enter some Quantity First !!!", Toast.LENGTH_SHORT).show();
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.sell_product:
                intent = new Intent(Product_Sell_Activity.this, Product_Sell_Activity.class);
                startActivity(intent);
                finish();
                break;
    ...
    public void onBackPressed() {
        Intent intent1 = new Intent(Product_Sell_Activity.this, MainActivity.class);
