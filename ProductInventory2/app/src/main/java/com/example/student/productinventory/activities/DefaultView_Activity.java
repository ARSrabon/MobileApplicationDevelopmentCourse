...
public class DefaultView_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sharedPreferences.getBoolean("loggedin", false)) {
            User user = User.load(User.class,sharedPreferences.getLong("userId",-1));
...
//        }
        ...
        switch (item.getItemId()) {
            ...
            case R.id.customerDues: intent = new Intent(DefaultView_Activity.this,CustomersDueActivity.class);
                startActivity(intent);
                finish();
                break;
